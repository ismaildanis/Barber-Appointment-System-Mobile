...
const styles = StyleSheet.create({
  ...
  addBtn: { backgroundColor: "#AD8C57", paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8 },
  ...
  label: { color: "#AD8C57", fontSize: 14, marginBottom: 8, fontWeight: "600" },
  ...
  option: { padding: 12 },
  optionActive: { backgroundColor: "#AD8C57" },
  ...
  saveBtn: { flex: 1, padding: 12, borderRadius: 8, backgroundColor: "#AD8C57", alignItems: "center" },
